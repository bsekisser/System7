 ...
 * Provenance: pattern analysis + string evidence from System.rsrc
 */
...
/* System trap numbers - evidence from implementation analysis */
 ...
 * patterns: 48 78 (PEA), a8 84 (trap), 4e 75 (RTS)
 */
 ...
 * patterns: 2f 3c (MOVE.L immediate), a8 93 (Gestalt), 4e 75 (RTS)
 */
 ...
 * patterns: 20 78 (MOVEA.L), 30 28 (MOVE.W), 61 1e (BSR)
 */
 ...
 * patterns: 48 78 (PEA), a8 84 (trap), 32 3c (MOVE.W immediate)
 */
 ...
 * patterns: 41 fa (LEA), 43 f8 (LEA), a0 3c (trap)
 */
 ...
 * patterns: 20 78 02 ae (MOVEA.L from low memory), 30 28 00 08 (MOVE.W)
 */
